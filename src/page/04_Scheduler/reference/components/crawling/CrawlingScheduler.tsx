...
import {
  addCrawlingSchedule,
  getCrawlingSchedules,
  cancelCrawlingSchedule,
  updateCrawlingSchedule,
  type CrawlingSchedule,
...
const CrawlingScheduler: React.FC = () => {
   ...
   */
  const [editingCronExpression, setEditingCronExpression] =
    useState<string>("");
  /**
  ...
  const handleAddSchedule = async () => {
    ...
    const generatedCron = generateCronExpression(
      frequency,
      minute,
      hour,
      dayOfWeek,
  ...
  return (
    <div className="crawling-scheduler-container">
      ...
      <div className="schedule-form">
        ...
        <p>
          현재 사용자 ID: <strong>{userId || "로그인 필요"}</strong>
        </p>
        ...
        <button onClick={handleAddSchedule} disabled={!userId}>
          스케줄 추가
        </button>
      </div>
